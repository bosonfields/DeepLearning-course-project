...
#output
<matplotlib.image.AxesImage at 0x7fd50539ae10>
...
imshow(style_image)
#output
<matplotlib.image.AxesImage at 0x7fd4e5f43d68>
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer =1/(4*n_C**2*(m*n_H*n_W)**2)*tf.reduce_sum(tf.square(tf.subtract(GS,GG)))
...
#output
<matplotlib.image.AxesImage at 0x7fd4e570a8d0>
